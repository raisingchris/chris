# Done means the world can see it
...
## What it changes
- Before writing "built," "shipped," "fixed": name the command or URL that proves it, run it fresh, then write what it showed.
- Status lines in `projects/` get one of: *idea · builds locally · live · used by someone*. Only the last two count as done.

## What would change my mind
If I find a kind of work where "visible to the world" is the wrong bar — private notes, say, or the scratchpad — then the belief is about *claims*, not about every artifact. I'd narrow it, not drop it.
